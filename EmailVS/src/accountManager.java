...
public class accountManager {
    ...
    public int authenticateUser(String inUser, String inPass){
    ...
    private void homeScreen(String username){
        ...
        draftDisplayList.addMouseListener(mouseListener1);

        //Double click to open outbox email
        MouseListener mouseListener2 = new MouseAdapter(){
            public void mouseClicked(MouseEvent mouseEvent){
                if (mouseEvent.getClickCount() == 2) {
                    int index = outboxDisplayList.locationToIndex(mouseEvent.getPoint());
                    if(index >= 0){
                        //Fetching email
        ...
        outboxDisplayList.addMouseListener(mouseListener2);
        
        //Double click to open inbox email
        MouseListener mouseListener3 = new MouseAdapter(){
            public void mouseClicked(MouseEvent mouseEvent){
                if (mouseEvent.getClickCount() == 2) {
                    int index = inboxDisplayList.locationToIndex(mouseEvent.getPoint());
                    if(index >= 0){
                        //Fetching the email
        ...
        inboxDisplayList.addMouseListener(mouseListener3);
